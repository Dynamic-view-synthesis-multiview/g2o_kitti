...
def process_frame(image, pose=None, verts=None):    #Note: We consider frame of first frame as world frame when starting VO
    ...
    frame1.pose = np.dot(Rt, frame2.pose)   #get pose of most recent frame from [pose of its prev frame and rel transfromation i.e Rt]  -- > also called as tracking (feature based tracking)
